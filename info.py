...
API_ID = int(environ.get('API_ID','28014081'))
API_HASH = environ.get('API_HASH','a44c2ada6e34b540d90bd51bb0b2009c')
...
SPELL_IMG = environ.get("SPELL_IMG", "https://telegra.ph/file/ffe40da9f61dfdd069ad6.jpg")

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6660929311 6794863440').split()]
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001762802051'))
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/kissuXbots')
